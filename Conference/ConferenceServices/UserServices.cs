...
namespace ConferenceServices
{
    public class UserServices : IProcess
    {
        ...
        public string GetUsersHardcodedListAsString()
        {
            ...
            {
                res += String.Format($"Id: {user.Id}, Name: {user.Name}, Email: {user.Email}") + System.Environment.NewLine;
            }
            return res;
        }
        ...
        public List<User> GetUsersHardcodedList()
        {
            ...
            userList.Add(new User() { Id = 0, Name = "Ana Popa Hardcoded", Email = "defaultemail@gmail.com" });
